...
const cards = [
  ...
  },
  {
    ...
    year: "+ 18",
    description:
      "Работаю на первом канале, а это значит, что тебе досталась крайне разговорчивая девушка, которая найдет информацию и все обсудит с тобой хлеще, чем в «Пусть Говорят»! Весьма наблюдательная, как Роза Сябитова и остра на язык как Гузеева. В общем, дивная брюнетка. Нам точно по пути ❤️",
    modal: {
      img: onem,
  ...
  return (
    <>
      <div className="cardsList">
        <div className="cardsList-header">
